    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('CREATE', 'Create'), ('ADD', 'Add child records'), ('MODIFY', 'Modify or edit record'), ('ISSUE', 'Issue'), ('RETURN', 'Return'), ('RENEW', 'Renew'), ('DELETE', 'Delete'), ('CHANGE PASS', 'Change Password Through Staff Client'), ('RESERVE', 'RESERVE through Staff Client'), ('FINE', 'Collect fine through Staff Client'), ('RUN', 'Run report')], max_length=11)),
            ],
        ),
        migrations.CreateModel(
            name='Authors',
